    ...
    <div class="row content">
        <div class="col-sm-3 sidenav">
            <form class="form-signin" action="registerform.php" method="post">
                <h2 class="form-signin-heading">Rekisteröi tunnus</h2>
                <label for="inputEmail" class="sr-only">Etunimi</label>
                <input type="text" id="inputName" name="fName" class="form-control" placeholder="Etunimi" required autofocus>
                <label for="inputPassword" class="sr-only">Sukunimi</label>
                <input type="text" id="inputLastname" name="lName" class="form-control" placeholder="Sukunimi" required>
                <br>
                <label for="inputEmail" class="sr-only">Sähköposti</label>
                <input type="email" id="inputEmail" name="email" class="form-control" placeholder="Sähköposti" required>
